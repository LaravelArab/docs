...
مجلد `storage` يحوي قوالب Blade المترجمة، الجلسات القائمة على الملف، ملف ذاكرة التخزين المؤقتة، وملفات أخرى قام بإنشائها إطار العمل. هذا المجلد ينقسم إلى مجلدات `app` و`framework` و`logs`. يمكن استخدام مجلد `app` لحفظ أي ملفات منشأة من قبل تطبيقك. يمكن استخدام مجلد `framework` لحفظ الملفات المنشأة وملفات ذاكرة التخزين المؤقتة. وأخيرا، يحوي مجلد `logs` ملفات السجل الخاصة بتطبيقك.
