...
بنية تطبيق لارافال المبدئية تهدف إلى توفير نقطة بداية عظيمة لتطبيقات الكبيرة والصغيرة. بالطبع أنت حر في تنظيم تطبيقك كما تشاء. لارافال لا يفرض تقريبا أي قيود على مكان وضع أي صنف (class) معين مادام Composer يستطيع تحميله آليا.
...
ملجد `app`، كما تتوقع، يحوي الشفرة الرئيسة لتطبيقك. سنتَـطَـرَّق للحديث عن هذا المجلد بالتفصيل قريبا. لكن -تقريبا- جميع الأصناف (classes) في تطبيقك ستكون داخل هذا المجلد.
